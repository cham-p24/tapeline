...
| Signup → trial | 100 % by construction (auto 14-day Premium trial, no card). ⚠️ **True only as of the 2026-08-20 snapshot** — #536 (2026-08-21) stopped signup granting any trial and #548 (2026-08-22) put a card wall at `/app/start` for new accounts, so this step is now a real, measurable drop-off. | Nothing *(now: the card wall and the trial opt-in)*. | No. |
