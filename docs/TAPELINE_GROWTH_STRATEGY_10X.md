...
- 14-day Premium trial, **card required at first sign-in** since #548 (2026-08-22) — $0 today, first charge on day 14, T-3 reminder email, one-click cancel — on top of the same layered abuse defence (email-normalize, IP cap, 30-day device fingerprint, honeypot, Turnstile, disposable-email block). Accounts created before 2026-08-22 are grandfathered and never asked for a card.
