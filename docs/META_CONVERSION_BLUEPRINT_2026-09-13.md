...
- **Correction, 2026-09-14:** the E bullet above wrongly cleared E's record line: "We publish every day" was false (the record has trading days with no top ten and dated corrections), as were E's "never re-ranked, back-filled or removed" and "written down when it prints"; E was rewritten in PR #PR_NUMBER (see `docs/ads/2026-09-video/README.md`).
