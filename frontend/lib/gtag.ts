...
export type TapelineEvent =
  ...
  // Trial → paid funnel
  | "start_trial"          // 30-day Premium trial started via Stripe Checkout — the /app/start trial screen or the /app/billing trial offer (card required, $0 today, first charge day 14). Neither is a wall since #683; signup itself does not fire this.
