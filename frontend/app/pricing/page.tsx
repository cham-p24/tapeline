...
import { VERIFIED_MISSING_SESSIONS, verifiedMissingSessionsLabel } from "@/app/scorecard/recordLimitationsData";
        ...
        <div className="section py-10 sm:py-12">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-2 text-sm text-muted">
              Each daily top 10 is logged the day it prints. When we checked on 14 September 2026, {VERIFIED_MISSING_SESSIONS.length} trading days had no list ({verifiedMissingSessionsLabel()}); the scorecard names every gap. Losing days stay, and corrections are dated in the changelog. These numbers are read from the scorecard when you open this page.
            </p>
          </div>
