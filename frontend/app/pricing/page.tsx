        ...
        <div className="section py-10 sm:py-12">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-2 text-sm text-muted">
              Each day&rsquo;s top 10 is logged the same day. Losing days stay, and corrections are dated in the changelog. These numbers are read from the scorecard when this page is rebuilt, so they can be a few hours behind it.
            </p>
          </div>
