...
const ADDRESSES: { label: string; email: string; desc: string }[] = [
  ...
  // seats, and that path ended on a page that did not list the address it had
  // just named. (The hand-sold Trader plan it also served left /pricing on
  // 2026-09-19.)
  { label: "Sales",       email: "sales@tapeline.io",   desc: "Team seats (5+) and anything not on the pricing page." },
