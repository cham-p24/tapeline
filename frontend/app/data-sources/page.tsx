...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    // "daily" here while the real rotation was ~30 days (#822). Read from SEC
    // EDGAR directly since #835 (2026-09-14); the vendor it replaced ran 14-67
    // days behind EDGAR for AAPL/NVDA/META.
    refreshCadence:
      "Form 4 read from SEC EDGAR, re-checked about every two days per stock (ETFs and other non-stocks about monthly). 8-Ks every 5 minutes.",
    publicRecord: true,
  },
  {
