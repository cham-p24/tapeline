    ...
    <SeoFeaturePage
      ...
      faq={[
        ...
        },
        {
          ...
          a: "Congressional trades are a Premium feature ($16.58/mo billed annually, or $19.99/mo monthly). The 30-day Premium trial includes the full feed. Premium also adds recent insider buys (SEC Form 4), and the largest watchlist / saved-scan caps.",
        },
      ]}
      tier="premium"
    >
