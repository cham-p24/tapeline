/**
 * Brand OG card for the Terms of Service page.
 *
 ...
 * (Note the deeper relative path: this segment is app/legal/terms.)
 * The PNG inherits X-Robots-Tag: noindex from the next.config.js per-path
