...
export const FACTORS: Factor[] = [
  ...
  },
  {
    ...
    computed: [
      ...
      "When a ticker's filings have all left the window, its reading is removed at the ticker's next re-check, not at once: about two days later for a stock, and up to about a month for an ETF. Until 14 September 2026 such a reading was never removed, and some tickers held a value with no filing on file at all; the changelog entry for that date has the details.",
    ],
    feeds: [
      {
        name: "SEC filings",
