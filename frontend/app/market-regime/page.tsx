    ...
    <SeoFeaturePage
      ...
      faq={[
        ...
        },
        {
          ...
          a: "Market regime is a Pro feature ($8.25/mo billed annually, or $9.99/mo monthly). The 30-day Premium trial includes it. Premium adds recent insider buys (SEC Form 4) on top of everything in Pro.",
        },
      ]}
      tier="pro"
    >
