...
// Per-page metadata so each ticker page has its own title + description.
// The OG image is generated by the sibling opengraph-image.tsx automatically.
export async function generateMetadata({ params }: { params: { symbol: string } }) {
  ...
  return {
    title: `${sym} score ${score} · ${signal}`,
    description: `Tapeline score ${score}/100 (${signal}) for ${data.name}. ${data.reason ?? "Six-factor synthesis updated live."} See the formula on /how-it-works.`,
