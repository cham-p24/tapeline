    ...
    <SeoFeaturePage
        ...
        body: (
          <>
            <p>
              ...
              15 minutes and re-read about every 60 seconds during US market
      ...
      faq={[
        ...
        },
        {
          ...
          a: "Stock market heatmap is a Pro feature ($8.25/mo billed annually, or $9.99/mo monthly). The 30-day Premium trial includes everything in Pro. Premium adds recent insider buys (SEC Form 4).",
        },
      ]}
      tier="pro"
    >
